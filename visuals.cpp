...
void Visuals::ManualAntiAim()
{
	...
	Color fc = (g_hvh.m_left ? g_menu.main.antiaim.color_manual_antiaim.get() : Color(0, 0, 0, 130));
	Color sc = (g_hvh.m_right ? g_menu.main.antiaim.color_manual_antiaim.get() : Color(0, 0, 0, 130));
	Color tc = (g_hvh.m_back ? g_menu.main.antiaim.color_manual_antiaim.get() : Color(0, 0, 0, 130));
